...
export default function Experiences() {
    return (
        <div id='experiences' className="bg-white shadow-lg w-full rounded-lg px-10 py-5 overflow-hidden ">
            <h2 className='mb-6 font-bold font-roboto  text-4xl group  flex items-center tracking-tighter'>

                <MdWorkspacePremium size={37} className='mr-2 group-hover:animate-wiggle ' />
                Experiences
            </h2>
            <div className="flex flex-col gap-20 ml-20 relative">
                ...
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center  '>
                        <div className='w-40 h-1 mt-0.5 border-t-2 border-dashed border-gray-300 mr-4'>
                        </div>
                        <div className='flex flex-col justify-items-start'>
                            <h3 className='text-xl text-gray-500 font-roboto font-bold flex items-center '>
                                <div>Open To Work</div>
                                <FaRegCircleDot className=' text-red-600 inline animate-ping ml-4' />
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='flex items-center  '>
                        ...
                        <div >
                            <h3 className='text-xl text-gray-500 font-roboto font-bold flex items-center '>
                                ...
                                <TiTick size={25} className=' text-green-500 inline ml-2' />
                            </h3>
                        </div>
                    </div>
                </div>
