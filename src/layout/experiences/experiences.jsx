...
export default function Experiences() {
    return (
        <div id='experiences' className="bg-white shadow-lg w-full rounded-lg px-7 lgpx-10 py-5 overflow-hidden ">
            ...
            <div className="flex flex-col gap-20 ml-0 lg:ml-20 relative">
                ...
                <div className='flex items-center'>
                    ...
                    <div className='flex items-center  '>
                        <div className='w-24 lg:w-40 h-1 mt-0.5 border-t-2 border-dashed border-gray-300 mr-4'>
                        </div>
                        <div className='flex flex-col justify-items-start'>
                            <h3 className='text-md lg:text-xl text-gray-500 font-roboto font-bold flex items-center '>
