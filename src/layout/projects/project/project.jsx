...
export default function Project({ project }) {
    ...
    return (
        <div>
            <div className="bg-black md:w-full md:h-40  rounded-md p-2 cursor-pointer transition-all duration-300">
                <img className=" md:w-full md:h-full  md:rounded-lg object-cover " src={`/projects/${project.image}.png`} alt="" />
            </div>
